                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('pelanggans.update', $pelanggan->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $pelanggan->nama) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-primary-500 focus:ring-primary-500" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="no_telp" id="no_telp" value="{{ old('no_telp', $pelanggan->no_telp) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-primary-500 focus:ring-primary-500">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-primary-500 focus:ring-primary-500">{{ old('alamat', $pelanggan->alamat) }}</textarea>
