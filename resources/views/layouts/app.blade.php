...
<head>
    ...
    <title>{{ config('app.name', 'Produksi dan Penjualan - Peternakan Ayam Rohmat') }}</title>
    ...
    <div class="flex-1 flex flex-col overflow-hidden print:overflow-visible print:block relative">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 print:overflow-visible print:bg-white print:p-0 pb-16 lg:pb-0 flex flex-col">
            ...
            <footer class="py-6 text-center text-sm text-gray-500 print:hidden w-full">
                &copy; {{ date('Y') }} <strong>Produksi dan Penjualan - Peternakan Ayam Rohmat</strong>. Hak Cipta Dilindungi.
            </footer>
        </main>
